...
<body>
	...
	<tr>
	<td>
	<form action="delmemo" method="post">
		<Input Type = "Submit" Value = "메모삭제 ▶">
	</form>
	</td>
	<td>
...
<tr>
	...
	<td>
			<Input Type = "Text" Name = "search" style = "width:80px">
	</td>
	<td>
			<Input Type = "Submit" Value = "메모검색 ▶">
			</td>
	</form>
		...
		<li> ${status.index+1}. ${memo.year}년 ${memo.month}월 ${memo.day}일 [ 메모 : ${memo.memo} ] [ 이미지 : ${memo.saveImagePath} ]</li>
		</c:forEach>	</td>
		</tr>
