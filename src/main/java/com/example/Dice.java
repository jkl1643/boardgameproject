...
public class Dice {
    ...
    public void setAces(int aces) { Aces = aces; }
    public int getTwos() { return Twos; }
    public void setTwos(int twos) { Twos = twos; }
    public int getThrees() { return Threes; }
    public void setThrees(int threes) { Threes = threes; }
    public int getFours() { return Fours; }
    public void setFours(int fours) { Fours = fours; }
    public int getFives() { return Fives; }
    public void setFives(int fives) { Fives = fives; }
    public int getSixes() { return Sixes; }
    public void setSixes(int sixes) { Sixes = sixes; }
    public int getThree_Of_A_Kind() { return Three_Of_A_Kind; }
    public void setThree_Of_A_Kind(int three_Of_A_Kind) { Three_Of_A_Kind = three_Of_A_Kind; }
    public int getFour_Of_A_Kind() { return Four_Of_A_Kind; }
    public void setFour_Of_A_Kind(int four_Of_A_Kind) { Four_Of_A_Kind = four_Of_A_Kind; }
    public int getFull_House() { return Full_House; }
    public void setFull_House(int full_House) { Full_House = full_House; }
    public int getSmall_Straight() { return Small_Straight; }
    public void setSmall_Straight(int small_Straight) { Small_Straight = small_Straight; }
    public int getLarge_Straight() { return Large_Straight; }
    public void setLarge_Straight(int large_Straight) { Large_Straight = large_Straight; }
