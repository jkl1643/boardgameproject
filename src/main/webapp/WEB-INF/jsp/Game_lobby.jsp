...
<gamemenu id="pggamemenu">
    <button id="createbtn" onclick="create1()">방 생성</button>
    <br> 게임 메뉴 버튼. (=방생성, 전체방, 대기방)
</gamemenu>
...
<div id="createRoom" class="modal">
    <div class="modal-content">
        ...
        <button id="createclose">창 닫기</button>
    </div>
</div>
...
<script type="text/javascript">
    ...
    webSocket = new WebSocket("ws://" + location.host + "/boardgameproject_war_exploded/chat");
