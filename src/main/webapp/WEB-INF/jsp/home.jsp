...
<title>보드게임: 문제있어?</title>
	<STYLE TYPE="text/css">
		...
		#logbox2 {background-image: url("brick.jpg"); width: 565px; height: 100px; border: 1px solid blue; margin-top: 5px; margin-left: 5px; margin-right: 5px; font-size: xx-large; display:inline-block; text-align: center}
