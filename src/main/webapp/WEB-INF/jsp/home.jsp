...
<!--
	...
	#logbox2 {background-image: url(''); width: 565px; height: 100px; border: 1px solid blue; margin-top: 5px; margin-left: 5px; margin-right: 5px}
-->
</STYLE>
</head>
<body>
	...
	<div id="logbox1">
		<div id="logbox2"></div>
			<div style="margin-left: 300px; margin-top: 20px; float: left; display: inline;">아이디</div>
 			<div style="margin-left: 400px; margin-top: -25px; float: left; display: inline;"><input type="text" placeholder="아이디 조건" id="idinput1"></div>
 			<div style="margin-left: 300px; margin-top: 20px; float: left;">패스워드</div>
 			<div style="margin-left: 400px; margin-top: -25px; float: left;"><input type="text" placeholder="비밀번호 조건" id="pwdinput1"></div>
 	</div>
</body>
</html>