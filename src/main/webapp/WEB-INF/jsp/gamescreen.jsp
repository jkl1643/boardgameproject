...
<div id="box">
    <div>
        <button type="button" id="dice1" onClick="keepDice1Button()"><img src="dice1.png" id="diceimg1" disabled=true>
        </button>
    </div>
    <div>
        <button type="button" id="dice2" onClick="keepDice2Button()"><img src="dice1.png" id="diceimg2" disabled=true>
        </button>
    </div>
    <div>
        <button type="button" id="dice3" onClick="keepDice3Button()"><img src="dice1.png" id="diceimg3" disabled=true>
        </button>
    </div>
    <div>
        <button type="button" id="dice4" onClick="keepDice4Button()"><img src="dice1.png" id="diceimg4" disabled=true>
        </button>
    </div>
    <div>
        <button type="button" id="dice5" onClick="keepDice5Button()"><img src="dice1.png" id="diceimg5" disabled=true>
        </button>
    </div>
    <div>
        <button id="roll" onClick="rollDiceButton()">굴리기</button>
    </div>
    <div class="divTable">
        <div class="divTableBody">
            <div class="divTableRow">
                <div class="divTableCell">에이스</div>
                <div class="divTableCell"><input type="button" value="0" id="button1" onClick="AcesButton()"
                                                 disabled=true></div>
                <div class="divTableCell"><input type="button" value="0" id="button2"></div>
            </div>
            <div class="divTableRow">
                <div class="divTableCell">투</div>
                <div class="divTableCell"><input type="button" value="0" id="button3" onClick="TwosButton()"
                                                 disabled=true></div>
                <div class="divTableCell"><input type="button" value="0" id="button4"></div>
            </div>
            <div class="divTableRow">
                <div class="divTableCell">쓰리</div>
                <div class="divTableCell"><input type="button" value="0" id="button5" onClick="ThreesButton()"
                                                 disabled=true></div>
                <div class="divTableCell"><input type="button" value="0" id="button6"></div>
            </div>
            <div class="divTableRow">
                <div class="divTableCell">포</div>
                <div class="divTableCell"><input type="button" value="0" id="button7" onClick="FoursButton()"
                                                 disabled=true></div>
                <div class="divTableCell"><input type="button" value="0" id="button8"></div>
            </div>
            <div class="divTableRow">
                <div class="divTableCell">파이브</div>
                <div class="divTableCell"><input type="button" value="0" id="button9" onClick="FivesButton()"
                                                 disabled=true></div>
                <div class="divTableCell"><input type="button" value="0" id="button10"></div>
            </div>
            <div class="divTableRow">
                <div class="divTableCell">식스</div>
                <div class="divTableCell"><input type="button" value="0" id="button11" onClick="SixesButton()"
                                                 disabled=true></div>
            ...
            <div class="divTableRow">
                ...
                <div class="divTableCell"><input type="button" value="0" id="button13" onClick="Three_Of_A_KindButton()"
                                                 disabled=true></div>
                <div class="divTableCell"><input type="button" value="0" id="button14"></div>
            </div>
            <div class="divTableRow">
                <div class="divTableCell">포-오브-카인드</div>
                <div class="divTableCell"><input type="button" value="0" id="button15" onClick="Four_Of_A_KindButton()"
                                                 disabled=true></div>
                <div class="divTableCell"><input type="button" value="0" id="button16"></div>
            </div>
            <div class="divTableRow">
                <div class="divTableCell">풀 하우스</div>
                <div class="divTableCell"><input type="button" value="0" id="button17" onClick="Full_HouseButton()"
                                                 disabled=true></div>
                <div class="divTableCell"><input type="button" value="0" id="button18"></div>
            </div>
            <div class="divTableRow">
                <div class="divTableCell">스몰 스트레이트</div>
                <div class="divTableCell"><input type="button" value="0" id="button19" onClick="Small_StraightButton()"
                                                 disabled=true></div>
                <div class="divTableCell"><input type="button" value="0" id="button20"></div>
            </div>
            <div class="divTableRow">
                <div class="divTableCell">라지 스트레이트</div>
                <div class="divTableCell"><input type="button" value="0" id="button21" onClick="Large_StraightButton()"
                                                 disabled=true></div>
                <div class="divTableCell"><input type="button" value="0" id="button22"></div>
            </div>
            <div class="divTableRow">
                <div class="divTableCell">찬스</div>
                <div class="divTableCell"><input type="button" value="0" id="button23" onClick="ChanceButton()"
                                                 disabled=true></div>
                <div class="divTableCell"><input type="button" value="0" id="button24"></div>
            </div>
            <div class="divTableRow">
                <div class="divTableCell">야찌</div>
                <div class="divTableCell"><input type="button" value="0" id="button25" onClick="YahtzeeButton()"
                                                 disabled=true></div>
